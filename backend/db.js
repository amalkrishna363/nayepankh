...
async function initDb() {
  ...
  await pool.query(
    `INSERT INTO admins (username, password) VALUES ('admin', $1) ON CONFLICT DO NOTHING`,
    [hash]
  );
  ...
  await pool.query(
    `INSERT INTO api_keys (label, key_hash, key_prefix) VALUES ('Default Key', $1, $2) ON CONFLICT DO NOTHING`,
